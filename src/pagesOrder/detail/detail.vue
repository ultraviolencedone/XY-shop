...
<template>
  ...
  >
    <template v-if="order">
      <!-- 订单状态 -->
      <view class="overview" :style="{ paddingTop: (safeAreaInsets?.top || 0) + 20 + 'px' }">
        <!-- 待付款状态:展示去支付按钮和倒计时 -->
...
function getMemberOrderLogisticsByIdData() { throw new Error('Function not implemented.') } function
getPayWxPayMiniPayAPI(arg0: { orderId: any }) { throw new Error('Function not implemented.') }

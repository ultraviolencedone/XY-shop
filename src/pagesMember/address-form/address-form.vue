...
// 获取收获地址的省县区
const onChangePicker: UniHelper.RegionPickerOnChange = (ev) => {
...
const getMemberAddressByIdData = async () => {
  ...
  if (query.id) {
    // 发送请求
    const res = await GetMemberAddresByIdAPI(query.id)
    // 把数据合并到表单中
  ...
  <view class="content">
    <form>
      ...
      <view class="form-item">
        ...
        <picker @change="onChangePicker" class="picker" mode="region" value="">

<!--
此文件为开发者工具生成，生成时间: 2026/1/13上午10:56:14
使用方法：
在 C:\Users\DELL\Desktop\Learn\uni-app\shop\dist\dev\mp-weixin\pages\goods\goods.wxml 引入模板
...
在 C:\Users\DELL\Desktop\Learn\uni-app\shop\dist\dev\mp-weixin\pages\goods\goods.wxss 中引入样式
```
  ...
  <view class="sk-container">
      ...
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-115 sk-text">128.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-905 sk-text"
            >钻石陶瓷涂层多用锅18cm 小奶锅</view
          >
          <view class="desc sk-transparent sk-text-0-0000-78 sk-text">安全耐用，易于清洗APP</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-2 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-241 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-978 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-52 sk-text">
              请选择收获地址
            </text>
          </view>
        </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 0px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-6667-268 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-6667-567 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
...
.sk-text-14-2857-115 {
  ...
  background-size: 100% 75.4687rpx;
...
.sk-text-0-0000-78 {
  ...
  background-size: 100% 23.4375rpx;
  position: relative !important;
}
.sk-text-14-2857-2 {
  background-image: linear-gradient(
...
.sk-text-31-6667-268 {
  ...
  background-size: 100% 70.3125rpx;
  position: relative !important;
}
.sk-text-31-6667-567 {
  background-image: linear-gradient(
